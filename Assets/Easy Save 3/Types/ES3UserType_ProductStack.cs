...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("eggsGenerated", "milkGenerated", "gridOffset", "previousPositions", "currentR", "currentC")]
	public class ES3UserType_ProductStack : ES3ComponentType
	{
		...
		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			...
			writer.WriteProperty("eggsGenerated", instance.eggsGenerated, ES3Type_int.Instance);
			writer.WriteProperty("milkGenerated", instance.milkGenerated, ES3Type_int.Instance);
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "eggsGenerated":
						instance.eggsGenerated = reader.Read<System.Int32>(ES3Type_int.Instance);
						break;
					case "milkGenerated":
						instance.milkGenerated = reader.Read<System.Int32>(ES3Type_int.Instance);
						break;
					case "gridOffset":
